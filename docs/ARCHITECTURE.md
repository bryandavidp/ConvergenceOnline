...
| Gráficos de tablero | Pack Cosmos generado como SVG + 4 packs raster con 36 PNG RGBA y miniaturas propias (`IconPacks`) |
...
- `sw.js` define `CACHE = 'cv-cache-v2.15.0'` — **debe subirse manualmente en cada release** junto con `VERSION` y los dos `?v=` de `index.html`.
